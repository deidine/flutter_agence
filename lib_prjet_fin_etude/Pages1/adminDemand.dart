...
class AdminCommande extends StatefulWidget {

  const AdminCommande({Key? key}) : super(key: key);

  @override
  State<AdminCommande> createState() => _AdminCommandeState();
}

class _AdminCommandeState extends State<AdminCommande> {

  Future getCommande() async {
    var data = {"id": id.toString(), "stus": 'En etant'};
  ...
  RefiserCommand({required String id_c, required String stus}) async {
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.center,
              ...
              children: [
                ...
                FlatButton(color: Colors.blue.shade400,
                  onPressed: () {
                    RefiserCommand(id_c: id_c, stus: stus);
                    Navigator.of(context).pop();
                    //Navigator.of(context).pop();
                  },
                            ...
                            child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Text('Refuser', style: TextStyle(fontSize: 13),),
                                  ],
                                )),
                            onPressed: () {
                              setState(() {
