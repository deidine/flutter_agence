      ...
      children: [
        ClipPath(
          ...
          clipper:  ShapeClipper(
              [
                Offset(width / 12, _height - 200),
                Offset(width / 10 * 5, _height - 10),
                Offset(width / 5 * 4, _height - 12),
                Offset(width / 3, _height )
              ]
          ),
        ),
/*
ClipPath(
          ...
          clipper:  ShapeClipper(
              [
                Offset(width / 3, _height + 25),
                Offset(width / 10 * 8, _height - 70),
                Offset(width / 5 * 4, _height - 70),
        ...
        ClipPath(
          ...
          clipper:  ShapeClipper(
              [
                Offset(width / 5, _height - 29),
                Offset(width / 3, _height - 60),
                Offset(width / 5 * 2, _height - 80),
