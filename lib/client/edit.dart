...
class edit extends StatefulWidget{
  ...
  // String numero;
  // String date;
  // edit({Key? key,required  this.nom,required this.prenom,required  this.prix, required this.numero, 
  // required this.date,required  this.telephone}) : super(key: key);
...
class _editState extends State<edit>{
 ...
 final items = [
  ...
  void initState() {
    ...
    super.initState();
      nom.text = 'deidine';
      prenom.text = 'cheigeur';
      date.text = '121212';
      prix.text = '121212';
      numero.text = '121212';
      telephone.text = '121212';
...
_date=DateFormat("yyyy-MM-dd").format(value!);
 ...
 _edit()  {
      var url = '${SERVER_NAME}client/edit.php';
    ...
    // if (data == "yes") {
    //   MyAlertDialog.showAlertDialog(title: "succse", 
    //   message: "l'information sont enregistrer en succs",
    //    myContext: context);
    //   nom.clear();
    //   prenom.clear();
